          ...
          <div class="box-body">
            ...
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $query = mysqli_query($con, "select m.nombre as  medico,p.usuario as  paciente,c.fecha,c.observaciones,c.estado_cita,c.id_cita from cita c inner join usuario m on c.id_medico = m.id inner join usuario p on p.id = c.id_paciente and c.fecha='$fecha' ") or die(mysqli_error());
                $i = 0;
