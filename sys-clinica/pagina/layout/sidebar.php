  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      ?>
        ...
        <li><a><i class="fa fa-database"></i> Veterinario<span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">

            <li><a href="../medico/medico.php">Veterinario</a></li>
            <li><a href="../medico/medico_historial.php">Historial Veterinario</a></li>
