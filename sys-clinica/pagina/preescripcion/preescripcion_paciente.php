    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <div class="box-body">
          ...
          <div class="box-header">
            <h3 class="box-title"> LISTA PREESCRIOCIONES</h3>
          </div><!-- /.box-header -->
          ...
          <div class="box-body">
            ...
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                c.historia,
                c.id_preescripcion 
                from preescripcion c 
                inner join usuario m on c.id_medico = m.id 
                inner join usuario p on p.id = c.id_cliente  
                where c.id_cliente='$id_paciente'") or die(mysqli_error());
                $i = 0;
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo "radiografia1"; ?></td>
                    <td><?php echo "sangre1"; ?></td>
