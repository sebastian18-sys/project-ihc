...
<head>
  ...
  <style type="text/css">
    #myInput {
      background-image: url('../actividades_financieras/css/buscador.png');
                ...
                <div class="box-body no-padding">
                  ...
                  <form class="form-inline" name="f1" action="../preescripcion/terminarVenta.php" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-3 btn-print">
                        <div class="form-group">
                          <label for="date">Veteriario</label>
                        </div><!-- /.form group -->
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-3 btn-print">
                        <div class="form-group">
                          <label for="date">Sangre</label>
                        </div><!-- /.form group -->
                      </div>
                      <div class="col-md-4 btn-print">
                        <div class="form-group">
                          <select class="form-control select2" name="sangre" >
                              <option value="">--Seleccione--</option>
                              <option value="DEA 1">DEA 1</option>
                              <option value="DEA 2">DEA 2</option>
                    ...
                    <div class="row">
                      <div class="col-md-3 btn-print">
                        <div class="form-group">
                          <label for="date">Radiografia</label>

                        </div><!-- /.form group -->
                      </div>
                      <div class="col-md-4 btn-print">
                        <div class="form-group">
                          <input class="form-control" id="historia" name="radiografia" placeholder="" required></input>
                          <br>
