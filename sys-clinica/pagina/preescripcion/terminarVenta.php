...
$sentencia_pedido = $base_de_datos->prepare("INSERT INTO preescripcion(id_cliente, id_medico,historia,id_sesion,fecha,radiografia,sangre) VALUES (?, ?, ?,?,?,?,?);");
$sentencia_pedido->execute([$id_cliente, $id_medico,$historia,$id_sesion,$fecha,$radiografia,$sangre]);
