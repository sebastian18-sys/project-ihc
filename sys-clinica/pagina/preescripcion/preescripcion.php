  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <a class="btn btn-warning btn-print" href="preescripcion_agregar.php" style="height:25%; width:15%; font-size: 12px " role="button">REGISTRAR </a>
        ...
        <div class="box-body">
          ...
          <div class="box-header">
            <h3 class="box-title"> PREESCRIPCIONES</h3>
          </div><!-- /.box-header -->
          ...
          <div class="box-body">
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                m.nombre as medico,
                p.usuario as paciente, 
                c.fecha,
                c.historia, 
                c.id_preescripcion,
                c.radiografia,
                c.sangre
                from preescripcion c inner join usuario m on c.id_medico = m.id inner join usuario p on p.id = c.id_cliente ") or die(mysqli_error());
                $i = 0;
          ...
          <div class="box-body">
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $row['id_preescripcion']; ?></td>
