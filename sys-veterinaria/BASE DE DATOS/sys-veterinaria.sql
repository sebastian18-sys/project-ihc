...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2020 a las 04:33:36
...
(1, 'cerrado', '10', '2020-06-03', '2020-06-03'),
(2, 'cerrado', '10', '2020-06-09', '2020-08-19'),
(3, 'abierto', '150', '2020-08-19', '0000-00-00');
...
INSERT INTO `citas` (`id_citas`, `descripcion`, `fecha_registro`, `fecha_reserva`, `codigo`) VALUES
(1, '12dsdfs', '2020-06-07', '2020-06-16', 3),
...
(6, 'a las 5pm', '2020-08-19', '2020-08-19', 8),
(7, 'rapido', '2020-08-19', '2020-08-26', 10);
...
INSERT INTO `clientes` (`id_cliente`, `nombre`, `telefono`, `dni`, `nombre_mascota`, `raza`) VALUES
(1, 'Richard', '934544555', '43242344', 'napoelon', 'chihuahua'),
...
(6, 'roger', '87879', '98787897', 'firukais', 'pequla');
...
INSERT INTO `configuracion` (`id_configuracion`, `titulo`, `servicios1`, `servicios2`, `servicios3`, `mision`, `imagen_galeria1`, `imagen_galeria2`, `vision`, `direccion`, `google_maps`, `facebook`, `twitter`) VALUES
(1, 'VETERINARIAs sistemasenoferta S.R.L', 'vacunas de cabello', 'ventas productos para animales', 'Primeros auxilios', 'Somos MÃ©dicos Veterinarios referentes en la salud y bienestar animal. Nuestra misiÃ³n como empresa lÃ­der en atenciÃ³n es ofrecer a nuestros clientes de los mejores productos y de las soluciones de mÃ¡s valor.', 'vete.jpg', 'veterinaria.PNG', 'Que nuestros clientes estes satisfechos con su servicio', 'Av. J. Velasco Alvarado Mza E- Lote 4- La boya Camanï¿½- Camanï¿½ ï¿½ Arequipa Cel: 964994094- 980195872 ', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30584.49704594896!2d-72.72868365155294!3d-16.62365069444902!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x914101e020118733%3A0xeebe6bc8a1bee4fb!2sHotel+de+Turistas!5e0!3m2!1ses!2spe!4v1562982130402!5m2!1ses!2spe', 'https://www.facebook.com/sistemasenoferta', 'https://www.facebook.com/sistemasenoferta');
...
(11, '10', 6, '2', 1, '2020-08-19'),
(12, '11', 7, '1', 2, '2020-08-19');
...
--
-- Volcado de datos para la tabla `detalles_ventas_servicios`
--

INSERT INTO `detalles_ventas_servicios` (`id_detalles`, `id_pedido`, `descripcion`, `monto`) VALUES
(4, 'servicios15', 'sdfsdf', 100),
...
(1, 'Veterinaria sistemasenoferta', '354355', 'av san jeroronimo', '935142132', 'rubro de veterinaria', '79325289_107343034108000_8331319381153808384_n.jpg', 'sistemasenoferta@gmail.com', 'Nuevo sol', 'S/.', 0);
...
INSERT INTO `historial` (`id_historial`, `descripcion`, `fecha_registro`, `tipo_historial`, `id_cliente`, `id_sesion`) VALUES
(1, 'asdasdad', '2020-06-06', 'historial', 5, 0),
...
(7, 'venir a las 5pm', '0000-00-00', 'cita', 1, 5),
(8, 'rapido', '0000-00-00', 'cita', 1, 5),
(9, 'esta enfermo', '2020-08-18', 'historial', 6, 5),
(10, 'rapdio', '0000-00-00', 'cita', 6, 5);
...
(217, 5, 'se ha desconectado el sistema en ', '2020-06-09 13:45:56'),
(218, 5, 'se ha desconectado el sistema en ', '2020-06-09 13:57:08'),
(219, 5, 'se ha desconectado el sistema en ', '2020-06-09 14:09:56'),
(220, 5, 'se ha desconectado el sistema en ', '2020-08-18 23:23:35'),
(221, 5, 'se ha desconectado el sistema en ', '2020-08-19 00:37:17'),
(222, 11, 'se ha desconectado el sistema en ', '2020-08-19 00:37:58'),
(223, 5, 'se ha desconectado el sistema en ', '2020-08-19 00:38:58'),
(224, 6, 'se ha desconectado el sistema en ', '2020-08-19 00:39:59'),
(225, 11, 'se ha desconectado el sistema en ', '2020-08-19 00:40:28'),
(226, 5, 'se ha desconectado el sistema en ', '2020-08-19 00:43:40'),
(227, 6, 'se ha desconectado el sistema en ', '2020-08-19 00:44:17'),
(228, 5, 'se ha desconectado el sistema en ', '2020-08-19 01:20:46'),
(229, 5, 'se ha desconectado el sistema en ', '2020-08-19 01:43:48'),
(230, 6, 'se ha desconectado el sistema en ', '2020-08-19 01:44:41');
...
(10, '2020-08-19', 5, 1, 300),
(11, '2020-08-19', 5, 2, 50);
...
(6, 'ricocan', 'croquetas para perros', 'kilos', 150, 100, '', '91', 'a'),
(7, 'huesos de hule', 'para perros', 'hueso', 50, 45, '', '139', 'a');
...
(5, 'admin', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', '1.jpg', 'administrador', 'sf', 'fdf', '', 'sistemasenoferta@gmail.com'),
(6, 'empleado', 'a1Bz20ydqelm8m1wql088ef99bff55c67dc863f83980a66a9b', '', 'empleado', 'fredy', 'mercury', '345543', 'mercury@gmail.com'),
...
(11, 'cliente', 'a1Bz20ydqelm8m1wql4983a0ab83ed86e0e7213c8783940193', '', 'cliente', '956454334', 'mamani', '9879879', 'cliente@gmail.com');
...
INSERT INTO `ventas_servicios` (`id_pedido`, `fecha`, `id_sesion`, `id_cliente`) VALUES
(3, '2019-12-05', 5, 2),
(4, '2019-12-05', 5, 4),
(5, '2020-06-05', 5, 5),
(6, '2020-06-05', 5, 5),
...
--
ALTER TABLE `citas`
  MODIFY `id_citas` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `clientes`
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `detalles_pedido`
  MODIFY `id_detalles` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `detalles_ventas_servicios`
--
ALTER TABLE `detalles_ventas_servicios`
  MODIFY `id_detalles` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `historial`
  MODIFY `id_historial` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `producto`
  MODIFY `id_pro` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
