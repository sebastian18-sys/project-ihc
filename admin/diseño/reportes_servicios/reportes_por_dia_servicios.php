...
           </div>
           <div class="col-md-3">
             <form method="post" action="reportes_por_dia_servicios.php" enctype="multipart/form-data" class="form-horizontal">
...
?>
   ...
   <?php
    ...
    $query=mysqli_query($con,"select * from ventas_servicios  where  fecha ='$fecha'  ")or die(mysqli_error());
    $contador=0;
