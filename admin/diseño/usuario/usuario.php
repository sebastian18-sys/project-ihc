...
#buscar{
 ...
 <!--end of modal-->
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> LISTA USUARIOS COORDINADOR</h3>
                </div><!-- /.box-header -->
...
<td><?php echo $row['usuario'];?></td>
  <td><?php echo $row['tipo'];?></td>      
    <td><?php echo $row['correo'];?></td>                                      
                      ...
                      ?>
  <a class="small-box-footer btn-print"  href="<?php  echo "eliminar_usuario.php?cid=$cid";?>"><i class="glyphicon glyphicon-remove" onClick="return confirm('¿Está seguro de que quieres eliminar usuario??');"></i></a>
