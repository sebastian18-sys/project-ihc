...
?>
 ...
 <a class = "btn btn-success btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Impresión</a>
                  ...
                  <h3 class="box-title"> Lista venta servicios total</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
?>
   ...
   <?php
    ...
    $query=mysqli_query($con,"select * from ventas_servicios    ")or die(mysqli_error());
    $contador=0;
...
?>
 ...
 <?php
    ...
    $query=mysqli_query($con,"select * from   ventas_servicios AS z
...
<td><?php echo $row['fecha'];?></td>
              <td><?php echo $row['nombre'];?></td>
                      ...
                      ?>
<a class="btn btn-danger btn-print" href="<?php  echo "generar_pdf_servicios.php?num_pedido=$num_pedido";?>"  target="_blank"   role="button">Ver comprobante</a>
