...
           </div>
           <div class="col-md-3">
             <form method="post" action="reportes_por_mes_servicios.php" enctype="multipart/form-data" class="form-horizontal">
...
?>
   ...
   <?php
    ...
    $query=mysqli_query($con,"select * from ventas_servicios  where  MONTH(fecha)='$mes'  ")or die(mysqli_error());
    $contador=0;
