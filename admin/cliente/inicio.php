...
<body class="nav-md">
  ...
  <div class="container body">  <!-- PRINCIPAL -->
    <div class="main_container"> <!-- PRINCIPAL 2 -->
      
      <?php include 'main_sidebar.php';?>
        <!-- top navigation -->
      <?php include 'top_nav.php';?> <!-- HEADER -->     
      <!-- /top navigation -->
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                  ...
                  <div class="icon">
                    <img height="80" width="80" src="img/cajero.png">
                    <i class=""></i>
                  </div>
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-orange">
                  ...
                  <div class="icon">
                    <img height="80" width="80" src="img/setting.png">
                    <i class=""></i>
                  </div>
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                  ...
                  <div class="icon">
                    <img height="80" width="80" src="img/planes.png">
                    <i class=""></i>
                  </div>
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                  ...
                  <div class="icon">
                    <img height="80" width="80" src="img/fair.png">
                    <i class=""></i>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                  ...
                  <div class="icon">
                    <img height="80" width="80" src="img/productos.png">
                    <i class=""></i>
                  </div>
